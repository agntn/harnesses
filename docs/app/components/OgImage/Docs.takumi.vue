...
const CHIPS = ["harnesses_detect", "harnesses_info", "harnesses_run", "harnesses_mcp_sync", "harnesses_agents_sync"];
</script>
  ...
  >
    ...
    <div class="flex items-center justify-between w-full">
      <div class="flex items-center">
        <div class="w-[10px] h-[10px] rounded-full" style="background-color: #fdba74" />
        <p
