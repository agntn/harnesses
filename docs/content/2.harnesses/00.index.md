...
description: Thirteen harnesses, one page each, with every path, template and marker straight from the registry.
navigation:
  title: Overview
---
...
| [Prime Agent](/harnesses/prime-agent) | `prime-agent` | env + project | advisor, agent | JSONL, JSON, dill |
